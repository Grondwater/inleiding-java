...
public class Opdracht13_3 extends Applet {
    ...
    public void paint(Graphics g) {
        if (output == 1) {
            bakstenen(g,10,10,400,300);
        } else if (output == 2) {
            beton(g,10,10,400,300);
        }
    }

    void bakstenen(Graphics g, int x, int y, int width, int height) {
        int teller;
    ...
    void beton(Graphics g, int x, int y, int width, int height) {
        int teller;
